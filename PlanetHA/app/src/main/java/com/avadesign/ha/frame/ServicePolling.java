	    	...
	    	try
	    	{
				...
				*/
				...
				httpClient.getCredentialsProvider().setCredentials(
		                ...
		                new UsernamePasswordCredentials(cp.getUserName(), cp.getUserPwd()));   
