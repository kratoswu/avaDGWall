...
public class ZWaveDeviceSettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zwave_dev_setting);
    ...
    private void initContentView() {
        ...
        String urlPattern = "http://{0}:{1}/PadVersion/device";
